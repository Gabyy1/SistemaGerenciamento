			...
			<table>
				<tr>
					<td colspan="3"><label for="cnpj">CNPJ</label> <input
						type="text" id="cnpj" name="cnpj" placeholder="Digite o CNPJ do fornecedor"
				...
				<tr>
					<td colspan="4"><label for="nome">Nome</label> <input
						type="text" id="nome" name="nome" placeholder="Digite o nome do fornecedor"
						value='${fornecedores.nome }'></td>
				</tr>
				<tr>
					<td colspan="4"><label for="telefone">Celular</label> <input
						type="text" id="telefone" name="telefone" placeholder="Digite o celular do fornecedor"
						value='${fornecedores.telefone }'></td>
				</tr>
				<tr>
					<td colspan="4"><label for="email">Email</label> <input
						type="text" id="email" name="email" placeholder="Digite o email do fornecedor"
						value='${fornecedores.email }'></td>
				</tr>
				<tr>
					<td colspan="4"><label for="cep">CEP</label> <input
						type="text" id="cep" name="cep" placeholder="Digite o CEP do fornecedor"
						value='${fornecedores.cep }'></td>
				</tr>
				<tr>
					<td colspan="4"><label for="logradouro">Logradouro</label> <input
						type="text" id="logradouro" name="logradouro"
						placeholder="Digite o logradouro do fornecedor" value='${fornecedores.logradouro }'>
					</td>
				</tr>
				<tr>
					<td colspan="4"><label for="numero">Número</label> <input
						type="number" id="numero" name="numero" min="0"
						placeholder="Digite o número do logradouro do fornecedor" value='${fornecedores.numero }'></td>
				</tr>
				<tr>
					<td colspan="4"><label for="bairro">Bairro</label> <input
						type="text" id="bairro" name="bairro" placeholder="Digite o bairro do fornecedor"
						value='${fornecedores.bairro }'></td>
				</tr>
				<tr>
					<td colspan="4"><label for="cidade">Cidade</label> <input
						type="text" id="cidade" name="cidade" placeholder="Digite a cidade do fornecedor"
						value='${fornecedores.cidade }'></td>
				</tr>
				<tr>
					<td colspan="4"><label for="estado">Estado</label> <input
						type="text" id="estado" name="estado" placeholder="Digite o estado do fornecedor"
