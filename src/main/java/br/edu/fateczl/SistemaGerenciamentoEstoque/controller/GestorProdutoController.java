...
public class GestorProdutoController {
	...
	@RequestMapping(name = "gestorProduto", value = "/gestorProduto", method = RequestMethod.GET)
	public ModelAndView init(ModelMap model) {
		return new ModelAndView("gestorProduto");
	}

	@RequestMapping(name = "gestorProduto", value = "/gestorProduto", method = RequestMethod.POST)
