...
@Controller
public class GestorRelatorioController {
	@Autowired
	GenericDao gDao;

	@RequestMapping(name = "gestorRelatorio", value = "/gestorRelatorio", method = RequestMethod.GET)
	public ModelAndView init(ModelMap model) {
		return new ModelAndView("gestorRelatorio");
	}

	@RequestMapping(name = "gestorRelatorio", value = "/gestorRelatorio", method = RequestMethod.POST)
	public ModelAndView post(ModelMap model) {
		return new ModelAndView("gestorRelatorio");
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	@RequestMapping(name = "gestorGeraRelatorio", value = "/gestorGeraRelatorio", method = RequestMethod.POST)
	public ResponseEntity gestorGeraRelatorio(@RequestParam Map<String, String> params) {
		String erro = "";
